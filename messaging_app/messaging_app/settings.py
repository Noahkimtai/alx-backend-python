...
SECRET_KEY = (
    "django-insecure-hu@eu*)jhsut0d5cv%ys6dezd6fw4jz6+g^^#=@%t+$1_04l+1"
)
...
DATABASES = {
    "default": {
        ...
        "PASSWORD": os.getenv("DB_PASSWORD", "msgpass"),
...
SIMPLE_JWT = {
    ...
    "ROTATE_REFRESH_TOKENS": True,  # Rotates refresh token upon usage
